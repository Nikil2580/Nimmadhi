...
final List<String> entries = <String>['step1.png', 'step2.png', 'step3.png','step4.png'];

final List<String> steps = <String>['Step 1: The Situation', 'Step 2: Write down your thoughts', 'Step 3: Evaluate the thought', 'Step 4: Make A Desicion'];

final List<bool> _selections = List.generate(steps.length, (_) => true);

final List<Widget> _pages = [Step1(), Step2(), Step3(), Step4()];
